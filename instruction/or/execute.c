...
{
	struct or_instruction* const this = (typeof(this)) super;
	...
	#ifdef ASM_VERBOSE
	{
		...
		assert(vr1.reg->kind == vk_bol || vr1.reg->kind == vk_int);
		assert(vr2.reg->kind == vk_bol || vr2.reg->kind == vk_int);
	}
	#endif
